...
(self.webpackChunktrinhminhtriet = self.webpackChunktrinhminhtriet || []).push([
    [279], {
        ...
        5675: function(e, t, n) {
            ...
            var ke = JSON.parse('[{"id":1,"title":"Cloud Engineer","content":"Designs, implements, and manages cloud-based infrastructure and services, ensuring scalability, security, and performance for business applications.","image":"/images/slider/unsplash-02.jpg"},{"id":2,"title":"Flutter App Developer","content":"Builds cross-platform mobile applications with a single codebase, delivering fast, responsive, and visually appealing apps for both Android and iOS.","image":"/images/slider/unsplash-01.jpg"},{"id":3,"title":"DevOps Engineer","content":"Bridges development and operations by automating workflows, managing CI/CD pipelines, and ensuring reliable, scalable, and efficient software delivery.","image":"/images/slider/unsplash-03.jpg"},{"id":4,"title":"Data Structures & Algorithms (DSA)","content":"Develops efficient problem-solving skills by designing and implementing algorithms with optimal data structures to improve performance and scalability.","image":"/images/slider/unsplash-04.jpg"}]');

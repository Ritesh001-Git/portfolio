/*! For license information please see app-bc8129b9e887084a8cd8.js.LICENSE.txt */
    ...
    [524], {
            ...
            function w(e, t) {
                if ("" !== t) {
                    ...
                    switch (s = t.substring(s + 1), o) {
                        case "J":
                            (o = (t = e._chunks).get(i)) ? 0 === o._status && (e = o._value, o._status = 1, o._value = s, f(e)): t.set(i, new l(1, s, e));
                            break;
                        case "M":
                            ...
                            o ? 0 === o._status && (e = o._value, o._status = 2, o._value = s, f(e)) : t.set(i, new l(2, s, e));
                            break;
                        case "P":
                            e._chunks.set(i, d(e, function(e) {
                        ...
                        case "S":
                            ...
                            break;
                        case "E":
                            t = JSON.parse(s), (o = Error(t.message)).stack = t.stack, (s = (t = e._chunks).get(i)) ? m(s, o) : t.set(i, new l(4, o, e));
                            break;
                        default:
                ...
                r.read().then((function t(a) {
                    ...
                    if (!a.done) {
                        ...
                        for (var i = a.indexOf(10); - 1 < i;) {
                            var c = e._partialRow,
                                u = a.subarray(0, i);
                            u = s.decode(u), w(e, c + u), e._partialRow = "", i = (a = a.subarray(i + 1)).indexOf(10)
                        }
                ...
                if (i) {
                    for (const e of c)
                        if (null != l && l[e]) {
                            ...
                            var f, m;
                            n.push(null == l ? void 0 : l[e]), null != t && null != (p = t[e]) && p.event ? null == l || null == (f = l[e]) || f.call(l, null == t || null == (m = t[e]) ? void 0 : m.event) : d.set(i, a({}, t, {
                                [e]: {
                                    callbacks: n
                                }
                            }))
        ...
        6462: function(e, t, n) {
            ...
            const S = (e, t) => e.substr(0, t.length) === t,
                ...
                A = (e, t) => ({
                    route: e,
                    score: e.default ? 0 : M(e.path).reduce(((e, t) => (e += 4, (e => "" === e)(t) ? e += 1 : j(t) ? e += 2 : D(t) ? e -= 5 : e += 3, e)), 0),
                    index: t
                }),
            ...
            const G = () => {},
                B = Q(((e, t) => {
                    ...
                    const {
                        ...
                        replace: p,
                        getProps: h = G
                    } = r, d = c(r, F), m = x(u, a), g = encodeURI(m), v = s.pathname === g, b = S(s.pathname, g);
            ...
            B.displayName = "Link", B.propTypes = {
                to: a.string.isRequired
            };
            ...
            const ae = e => {
                    ...
                    o.useEffect((() => (oe++, m(), () => {
                        ...
                        let e = !1,
                            t = !1;
                        a !== h.current && (h.current = a, e = !0), s.pathname !== d.current && (d.current = s.pathname, t = !0), f.current = e || t && s.pathname === a, f.current && m()
                    }), [a, s]);
                    const m = o.useCallback((() => {
                        var e;
                        p.current ? p.current = !1 : (e = l.current, f.current && e && e.focus())
                    }), []);
            ...
            function ce(e) {
                const {
                    ...
                    basepath: a,
                    component: s = "div"
                } = e, u = c(e, se), l = o.Children.toArray(r).reduce(((e, t) => {
                    const n = U(a)(t);
                    return e.concat(n)
                }), []), {
                    pathname: p
                ...
                if (h) {
                    ...
                    } = h, p = c.default ? a : c.path.replace(/\*$/, ""), d = i({}, e, {
                        uri: r,
                        location: t
                    }), f = o.cloneElement(l, d, l.props.children ? o.createElement(ie, {
                        location: t,
                        primary: n
                    }, l.props.children) : void 0), m = n ? re : s, v = n ? i({
                        uri: r,
                        location: t,
                        component: s
                    }, u) : u;
        ...
        6498: function(e, t, n) {
            ...
            var k = function(e) {
                ...
                x = n(8797),
                O = n(9732);
            const T = new l.N5(S, [], window.pageData);
            (0, l.iC)(T), T.setApiRunner(o.N);
            const {
                render: N,
                hydrate: j
            } = (0, O.n)();
            window.asyncRequires = S, window.___emitter = h.A, window.___loader = l.Zf, s.globalHistory.listen((e => {
            ...
            (0, o.v)("onClientEntry").then((() => {
                        ...
                        return (0, r.A)(o, n), o.prototype.render = function() {
                            return a.createElement(t.Consumer, null, (t => {
                                ...
                                return a.createElement(P, {
                                    ...
                                    path: "/404.html" === n.page.path || "/500.html" === n.page.path ? (0, x.A)(r.pathname, "") : encodeURI((n.page.matchPath || n.page.path).split("?")[0])
                                }, this.props, {
                                    location: r,
                                    pageResources: n
                                }, n.json)))))
                ...
                f && "" + f !== m.pathname + (f.includes("?") ? m.search : "") && !(T.findMatchPath((0, x.A)(m.pathname, "")) || f.match(/^\/(404|500)(\/?|.html)$/) || f.match(/^\/offline-plugin-app-shell-fallback\/?$/)) && (0, s.navigate)("" + f + (f.includes("?") ? "" : m.search) + m.hash, {
                    replace: !0
                });
                const g = () => {
                    try {
        ...
        6814: function(e, t, n) {
                ...
                return t.memoizedGet = function(e) {
                    ...
                    const r = Promise.all(n).then((e => {
                        ...
                        const {
                            ...
                            staticQueryHashes: l = [],
                            slicesMap: h = {}
                        } = i, d = {}, f = Array.from(new Set(Object.values(h))), m = e => {
                        ...
                        return Promise.all(f.map((e => this.loadSliceDataJson(e)))).then((e => {
                            ...
                            const y = [Promise.all(h.map(m)), this.loadComponent(c, "head")];
                            ...
                            const w = Promise.all(y).then((e => {
                                    ...
                                    if ((!c || c instanceof Error) && (d.status = p.Error, d.error = c), d.status !== p.Error) {
                                        if (d.status = p.Success, !0 !== r.notFound && !0 !== (null == s ? void 0 : s.notFound) || (d.notFound = !0), i = Object.assign(i, {
                                                webpackCompilationHash: n ? n.webpackCompilationHash : ""
                                            }), "string" == typeof(null == s ? void 0 : s.payload)) {
                                            u = g(i, null, o), u.partialHydration = s.payload;
                            ...
                            return Promise.all([w, b]).then((e => {
                                ...
                                }, d.payload = n, u.A.emit("onPostLoadPageResources", {
                                    page: n,
                                    pageResources: n
                    ...
                    if (n) {
                        const e = g(n.payload);
                        return [].concat((0, o.A)(w(e.page.componentChunkName)), [h(t)])
                    }
                    return null
            ...
            let b, _ = function(e) {
                ...
                return n.doPrefetch = function(t) {
                    ...
                    return e.prototype.loadPageDataJson.call(this, t).then((e => e.notFound ? d(t) ? e : f(t, "HEAD").then((t => 200 === t.status ? {
                        status: p.Error
                    } : e)) : e))
                }, n.loadPartialHydrationJson = function(t) {
                    return e.prototype.loadPartialHydrationJson.call(this, t).then((e => e.notFound ? d(t) ? e : f(t, "HEAD").then((t => 200 === t.status ? {
                        status: p.Error
                    } : e)) : e))
                }, t
            }(y);
        ...
        6877: function(e, t, n) {
            t.components = {
                "component---src-pages-404-jsx": () => Promise.all([n.e(869), n.e(223), n.e(415)]).then(n.bind(n, 5421)),
                "component---src-pages-articles-jsx": () => Promise.all([n.e(869), n.e(223), n.e(744)]).then(n.bind(n, 5789)),
                "component---src-pages-contact-jsx": () => Promise.all([n.e(869), n.e(223), n.e(755)]).then(n.bind(n, 5907)),
                "component---src-pages-index-jsx": () => Promise.all([n.e(869), n.e(223), n.e(279)]).then(n.bind(n, 5675)),
                "component---src-pages-privacy-policy-jsx": () => Promise.all([n.e(869), n.e(223), n.e(430)]).then(n.bind(n, 3968)),
                "component---src-pages-terms-jsx": () => Promise.all([n.e(869), n.e(223), n.e(162)]).then(n.bind(n, 9173)),
                "component---src-pages-work-jsx": () => Promise.all([n.e(869), n.e(223), n.e(74)]).then(n.bind(n, 9860))
            }
        },
        7035: function(e, t, n) {
            "use strict";
        ...
        7078: function(e, t, n) {
            ...
            const f = (e, t) => "number" == typeof e ? e : l(e) ? h(e) ? function(e) {
                    const t = p(e),
                        n = "always";
                    return d(t, n)
                }(e) : function(e, t) {
            ...
            class y extends o.Component {
                ...
                render() {
                    const e = this.props,
                        ...
                        g = f(t, h.pathname);
                    return l(g) ? o.createElement(a.Link, i({
                        to: g,
                        state: u,
                        getProps: n,
        ...
        8710: function(e, t) {
            ...
            t.onRouteUpdate = function(e, t) {
                ...
                var r = t.pluginConfig || {};
                if (n && void 0 !== window.excludeGtagPaths && window.excludeGtagPaths.some((function(e) {
